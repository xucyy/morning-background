package com.ufgov.sssfm.project.tool.gen.util;

import com.ufgov.sssfm.common.constant.CommonMap;
...
{
    /** 项目空间路径 */
    private static final String PROJECT_PATH = "main/java/com/ufgov/sssfm/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.ufgov.sssfm.project.system"));
    }
}
