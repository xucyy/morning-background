package com.ufgov.sssfm.project.module.medicalAdjust.entity;

public class FmMedicalAdjust {
    private String id;
    ...
    private String tjjQuarter;

    private String ljjyQuarter;

    private String sbshjeQuarter;

    private String czsdjeQuarter;
    ...
    public String getTjjQuarter() {
        return tjjQuarter;
    }

    public void setTjjQuarter(String tjjQuarter) {
        this.tjjQuarter = tjjQuarter == null ? null : tjjQuarter.trim();
    }

    public String getLjjyQuarter() {
        return ljjyQuarter;
    }

    public void setLjjyQuarter(String ljjyQuarter) {
        this.ljjyQuarter = ljjyQuarter == null ? null : ljjyQuarter.trim();
    }

    public String getSbshjeQuarter() {
        return sbshjeQuarter;
    }

    public void setSbshjeQuarter(String sbshjeQuarter) {
        this.sbshjeQuarter = sbshjeQuarter == null ? null : sbshjeQuarter.trim();
    }

    public String getCzsdjeQuarter() {
        return czsdjeQuarter;
    }

    public void setCzsdjeQuarter(String czsdjeQuarter) {
        this.czsdjeQuarter = czsdjeQuarter == null ? null : czsdjeQuarter.trim();
    }
